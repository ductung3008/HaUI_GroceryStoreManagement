		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (newPass.equals(curPass)) {
					JOptionPane.showMessageDialog(ChangePasswordView.this, "Mật khẩu mới không được trùng mật khẩu cũ.", "Error",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
				
				if (!newPass.equals(rePass)) {
					JOptionPane.showMessageDialog(ChangePasswordView.this, "Mật khẩu không khớp. Vui lòng nhập lại.", "Error",
							JOptionPane.ERROR_MESSAGE);
					return;
				}
